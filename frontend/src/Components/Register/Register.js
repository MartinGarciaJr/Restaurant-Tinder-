...
const Register = (props) => {
    ...
    const checkPassword = (val) => /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,20}$/.test(val);
        ...
        <div className="row row-content justify-content-center "  style={{ backgroundColor: "#BDA656" ,backgroundImage: "url(" + Tender + ")" }}>
            ...
            <Control.text
                ...
                messages={{
                  ...
                  checkPassword: 'password must be between 8--20 characters and contain one numeric digit, one uppercase and one lowercase letter'
                }}
