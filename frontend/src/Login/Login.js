...
import { addToken, addUser,addFavorites } from "../../Redux/actionCreators";
import { baseUrl } from "../Shared/baseUrl";
import axios from "axios";
import resized from "../Shared/images/resized.jpg";
import { Card, CardTitle, Breadcrumb, BreadcrumbItem, Row, Label } from "reactstrap";
...
class Login extends Component {
  ...
  handleLogin = async () => {
    ...
    const userWithToken = await axios
     ...
     this.props.dispatch(addFavorites(s));
  });
